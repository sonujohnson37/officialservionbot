...
BOT_TOKEN = environ.get('BOT_TOKEN', "8254327437:AAEpMgTXvuGUKzLxClkZHXhpwalYHAwvChA")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://files.catbox.moe/72fcnu.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002758990595').split()]  # For Multiple Id Use One Space Between Each.
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003451137067')).split()]  # For Multiple Id Use One Space Between Each.
...
DATABASE_NAME = environ.get('DATABASE_NAME', "iqanimes")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'IQanpossible')
...
MSG_ALRT = environ.get('MSG_ALRT', 'Huh! you are not that lucky 😒')
